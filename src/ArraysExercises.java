...
//        Create an array that holds 3 Person objects. Assign a new instance of the Person class to each element. Iterate through the array and print out the name of each person in the array.
        ...
        for( Person n: person){
            System.out.println(n.getName());//in Person.java
        }
...
//        Create a static method named addPerson. It should accept an array of Person objects, as well as a single person object to add to the passed array. It should return an array whose length is 1 greater than the passed array, with the passed person object at the end of the array.
        public static Person[] addPerson(Person[] existingPerson, Person newPerson){
            Person[] addPerson = Arrays.copyOf(existingPerson, existingPerson.length+1);
            addPerson[existingPerson.length] = newPerson;
            return addPerson;
        }
